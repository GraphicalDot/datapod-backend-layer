...
{'error': True,
 ...
 error: {'message': 'Please enter a mnemonic of length 12, Invalid Mnemonic',
 		'error': True,
 		'success': False,
 		'Data': None}


 error: {'message': 'Password do not match with the sotred password',
 		'error': True,
 		'success': False,
 		'Data': None}


error: {'message': 'sha3_256 hash of mnemonic didnt match',
 		'error': True,
 		'success': False,
 		'Data': None}
