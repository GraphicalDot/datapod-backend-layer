...
from ..errors.errors import request_http_error, request_url_error, APIBadRequest, IdentityAlreadyExists, IdentityExistsNoPath, IdentityDoesntExists
...
class GithubIdentity(object):
    ...
    async def __init__(self, config, hostname, key_name, username, password):
        """
