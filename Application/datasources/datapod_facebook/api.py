...
from .db_calls import get_stats, get_status, filter_chats, filter_images, dashboard_data, delete_status, update_status, delete_archive
...
async def parse(request):
    ...
    try:
        ...
        await update_status(config[DATASOURCE_NAME]["tables"]["status_table"], DATASOURCE_NAME, request.json["username"], "PROGRESS", checksum, dest_path, request.json["path"])
