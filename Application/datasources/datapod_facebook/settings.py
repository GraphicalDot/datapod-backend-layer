...
from .api import parse, images, stats, status, get_chats, dashboard
import os
...
class Routes:
    def __init__(self, db_path):
        ...
        self.routes = {"GET": [("images", images), ("dashboard", dashboard), ("chats", get_chats), ("stats", stats), ("status", status)], 
                    "POST": [("parse", parse)] } 
